...
public class DrawerManagerSingleton
{
    private static readonly DrawerManagerSingleton _instance = new();

    public static DrawerManagerSingleton Instance => _instance;

    public static Dictionary<string, List<IDrawer>> Drawers;

    private DrawerManagerSingleton()
    {
        Drawers = new();
    }
